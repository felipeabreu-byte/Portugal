...
export default function SettingsPage() {
    ...
    const [travelData, setTravelData] = useState<{ travelDate: string | null; city: string | null; profile: any | null } | null>(null);
        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-gray-500 mt-1">Gerencie seus dados pessoais, objetivos financeiros e detalhes da viagem.</p>
                </div>
                <Link
                    href="/dashboard"
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 items-start">
                ...
                <div className="space-y-6">
                    {travelData && <TravelForm initialData={travelData} />}
                </div>
            </div>
        </div>
    );
