...
import { getExpenses } from "@/actions/planning";
        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-gray-500 mt-1">Simule e organize seus gastos nos primeiros meses em Portugal.</p>
                </div>
            </div>

            <ExpensePlanner initialExpenses={formattedExpenses} />
        </div>
    );
}
